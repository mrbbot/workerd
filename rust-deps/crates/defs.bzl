...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "anyhow": "@crates_vendor__anyhow-1.0.66//:anyhow",
            "backtrace": "@crates_vendor__backtrace-0.3.66//:backtrace",
            "clang-ast": "@crates_vendor__clang-ast-0.1.9//:clang_ast",
            "cxx": "@crates_vendor__cxx-1.0.82//:cxx",
            ...
            "serde": "@crates_vendor__serde-1.0.148//:serde",
            "serde_json": "@crates_vendor__serde_json-1.0.89//:serde_json",
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor__anyhow-1.0.66",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.anyhow-1.0.66.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.cc-1.0.77.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__clang-ast-0.1.9",
        sha256 = "f2ec567dd2f3a079936500b168b605e9d840ebc7b919a5b3b3e14f09ad79d07a",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/clang-ast/0.1.9/download"],
        strip_prefix = "clang-ast-0.1.9",
        build_file = Label("@workerd//rust-deps/crates:BUILD.clang-ast-0.1.9.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__cxx-1.0.82",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.cxx-1.0.82.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__cxxbridge-flags-1.0.82",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.cxxbridge-flags-1.0.82.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__cxxbridge-macro-1.0.82",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.cxxbridge-macro-1.0.82.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.itoa-1.0.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.libc-0.2.137.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.once_cell-1.16.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.proc-macro2-1.0.47.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.ryu-1.0.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.semver-1.0.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.serde-1.0.148.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__serde_derive-1.0.148",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.serde_derive-1.0.148.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__serde_json-1.0.89",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.serde_json-1.0.89.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__syn-1.0.104",
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.syn-1.0.104.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.thiserror-1.0.37.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.thiserror-impl-1.0.37.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@workerd//rust-deps/crates:BUILD.unicode-ident-1.0.5.bazel"),
    )
